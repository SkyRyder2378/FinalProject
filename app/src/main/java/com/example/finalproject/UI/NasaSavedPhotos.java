...
public class NasaSavedPhotos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.nasaRecycler.setAdapter(nasaAdapter = new RecyclerView.Adapter<NasaSavedPhotos.SavesRowHolder>() {
            @NonNull
            @Override
            public NasaSavedPhotos.SavesRowHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view;
                NasaSavedPhotos.SavesRowHolder rowHolder;
                ...
                rowHolder = new NasaSavedPhotos.SavesRowHolder(newBinding.getRoot());
                return rowHolder;
            }

            @Override
            public void onBindViewHolder(@NonNull NasaSavedPhotos.SavesRowHolder holder, int position) {
